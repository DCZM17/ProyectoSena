...
CALL add_Empleado('dczapata55@gmail.com','Jefe',FALSE,'CC','1031804155','Duvan','Zapata','3117034623','cra 92b # 127 b 33','1');
...
CALL add_Empleado('dfpiamonte@gmail.com','Conductor',FALSE,'CC','1042930471','David','Piamonte','32874596321','avenida caracas 65 15','4');
CALL add_Empleado('ducadianis@hotmail.com','Conductor',TRUE,'CE','1019038541','Diana','Reyes','3134470215','carrera 82 # 39a 14','5');

/* Creacion de usuario*/
INSERT INTO Usuario VALUES (NULL,'pnlopez55@gmail.com','12345','Supervisor',TRUE);
