    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-3">                 
                  <button class="btn btn-primary" id="iniciar_hora" data-id="<%= session.getAttribute("idUsuario") %>">Iniciar</button>
                </div>
              </div>
              <br>
                <table class="table" id="example"> 
                  ...
                  <tbody id="mostrar">
                    ...
                    <tr>
                      <td>${horarioRList.getNombreEmpleado()}</td>
                      <td>${horarioRList.getApellidoEmpleado()}</td>
