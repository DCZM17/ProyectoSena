                  ...
                  <tbody>
                    <c:forEach var="empleadoL" items="${empleadoList}">  
                      <tr>
                        ...
                        <td>${empleadoL.getHoraEntradaAsignada()}</td>
                        <td>${empleadoL.getHoraSalidaAsignada()}</td>
                        <td>
                          <c:if test="${empleadoL.getEstadoUsuario() == true}">
                            <span> Activo </span>
                          </c:if>
                            <c:if test="${empleadoL.getEstadoUsuario() == false}">
                              <span> Inactivo </span>
                            </c:if>
                        </td>
                        <td><a href="empleado?action=editar&idEmpleado=${empleadoL.getIdEmpleado()}"> <img src="views/assets/img/editar.png" style="width: 25px;"></a></td>
                      </tr>
                      </c:forEach> 
                  </tbody>
                </table>
