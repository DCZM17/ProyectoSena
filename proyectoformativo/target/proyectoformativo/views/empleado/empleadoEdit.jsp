                ...
                <form action="empleado" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="nombreEmpleado" id="nombreEmpleado" class="form-control" placeholder="Nombre Empleado" value="${empleadoL.getNombreEmpleado()}">
                        </div>
                        <input hidden name ="idUsuario" id="idUsuario" type="number" value="${empleadoL.getIdUsuario()}">
                        <input hidden name ="idEmpleado" id="idEmpleado" type="number" value="${empleadoL.getIdEmpleado()}">
                        <div class="col-sm-6">
                            <label class="label">Apellido Empleado: <span class="text-danger">*</span></label>
                            <input type="text" name="apellidoEmpleado" id="apellidoEmpleado" class="form-control" placeholder="Apellido Empleado" value="${empleadoL.getApellidoEmpleado()}">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <select name="tipoDocEmpleado" id="tipoDocEmpleado" class="form-control" value="${empleadoL.getTipoDocEmpleado()}">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="number" name="docEmpleado" id="docEmpleado" class="form-control" placeholder="Número de Documento" value="${empleadoL.getDocEmpleado()}" readonly>
                        </div>
                        <div class="col-sm-4">
                            <label class="label">Número de Celular: <span class="text-danger">*</span></label>
                            <input type="number" name="celularEmpleado" id="celularEmpleado" class="form-control" placeholder="Número de Celular" value="${empleadoL.getCelularEmpleado()}">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="direccionEmpleado" id="direccionEmpleado" class="form-control" placeholder="Dirección" value="${empleadoL.getDireccionEmpleado()}">
                        </div>
                        <div class="col-sm-4">
                            <label class="label">Correo Electronico: <span class="text-danger">*</span></label>
                            <input type="email" name="correoUsuario" id="correoUsuario" class="form-control" placeholder="Correo Electronico" value="${empleadoL.getCorreoUsuario()}">
                        </div>
                        <div class="col-sm-4">
                          <label class="label">Contraseña<span class="text-danger">*</span></label>
                        <input type="password" name="contrasenaUsuario" id="contrasenaUsuario" class="form-control" placeholder="Correo Electronico" value="${empleadoL.getContrasenaUsuario()}">
                        </div> 
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-sm-4">
                          ...
                          <select name="rolUsuario" id="rolUsuario" class="form-control" value="${empleadoL.getRolUsuario()}">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select name="estadoUsuario" id="estadoUsuario" class="form-control" value="${empleadoL.getEstadoUsuario()}">
                                <option  selected disabled>Seleccione..</option>
                    ...
                    <div class="card-footer" style="text-align: center;">
                      <button type="submit" name="action" value="edit" class="btn btn-primary">Actualizar empleado</button>
                    </div>
                </form>
              </c:forEach> 
            </div>
...
<script src="views/assets/js/AlertasEm.js"></script>
<script src="views/assets/js/sw2.js"></script>
