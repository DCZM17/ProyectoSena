  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-body">
              <c:forEach var="asigHorario" items="${listarHorarioAsig}">  
                <form action="horarioAsig" method="post">
                    <br>
                    <div class="row">
                        <div class="col-sm-4">
                            <label class="label">Hora de Entrada:<span class="text-danger">*</span></label>
                            <input type="time"   name="horaEntradaAsignada" id="horaEntradaAsignada" class="form-control" value="${asigHorario.getHoraEntradaAsignada()}">
                            <input hidden name ="idHorarioAsignado" type="number" value="${asigHorario.getIdHorarioAsignado()}">
                        </div>
                        <div class="col-sm-4">
                            <label class="label">Hora de Salida:<span class="text-danger">*</span></label>
                            <input type="time"   name="horaSalidaAsignada" id="horaSalidaAsignada" class="form-control" value="${asigHorario.getHoraSalidaAsignada()}">
                        </div>
                        <div class="col-sm-4">
...
<script src="views/assets/js/AlertasHAsig.js"></script>
