                ...
                <form action="horarioAsig" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="time" name="horaEntradaAsignada" id="horaEntradaAsignada" class="form-control" required>
                        </div>
                        <div class="col-sm-4">
                            <label class="label">Hora de Salida: <span class="text-danger">*</span></label>
                            <input type="time" name="horaSalidaAsignada" id="horaSalidaAsignada" class="form-control" required>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="card-footer" style="text-align: center;">
                        <button type="submit" name="action" value="add" class="btn btn-primary">Crear Horario</button>
                      </div>
                </form>
            </div>
        </div>
