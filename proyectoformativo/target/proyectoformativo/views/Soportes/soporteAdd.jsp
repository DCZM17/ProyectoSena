        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="soporte" method="post">
                    <input type="hidden" name="idEmpleado" value="<%=session.getAttribute("idUsuario")%>">
                    <br>
                    <div class="row">
                        <div class="col-sm-4">
                            <label class="label">Tipo de Soporte: <span class="text-danger">*</span></label>
                            <select name="tipoSoporte" id="tipoSoporte" class="form-control" required>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <label class="label">Adjuntar Soporte: <span class="text-danger">*</span></label>
                            <input type="file" name="soporte" id="soporte" class="form-control" placeholder="Adjuntar Soporte" required>
                        </div>
                            <div class="col-sm-4">
                                <label class="label">Descripción: <span class="text-danger">*</span></label>
                                <textarea name="descripcionSoporte" id="descripcionSoporte" cols="300" rows="100" class="form-control" style="height: 20px;" required></textarea>
                            </div>
                            <div class="col-sm-4">
                              <label class="label">Estado: <span class="text-danger">*</span></label>
                              <select name="estadoSoporte" id="estadoSoporte" class="form-control" >
                    ...
                    <div class="card-footer" style="text-align: center;">
                        <button type="submit" name="action" value="registraradd" id="btn1" class="btn btn-primary">Crear soporte</button>
                      </div>
                </form>
            </div>
        </div>
...
<script src="views/assets/js/AlertasSo.js"></script>
