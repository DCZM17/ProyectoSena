...
<body>
                ...
                <table class="table" id="example">
                  ...
                  <tbody id="mostrar">
                    <c:forEach var="soporteL" items="${soporteList}"> 
                      <tr>
                    <td>${soporteL.getNombreEmpleado()}</td>
                    <td>${soporteL.getApellidoEmpleado()}</td>
                    <td>${soporteL.getTipoSoporte()}</td>
                    <td>${soporteL.getDescripcionSoporte()}</td>
                    <td>${soporteL.getSoporte()}</td>
                    <td>${soporteL.getFechaRegistro()}</td>
                    <td>${soporteL.getFechaSoporte()}</td>
                    <td>
                      <c:if test="${soporteL.getEstadoSoporte() == true}">
                        <a href="soporte?action=estado&idSoporte=${soporteL.getIdSoporte()}&estado=false"><button class="btn btn-info" type="button">Aprobado </button> </a> 
                </c:if>
                <c:if test="${soporteL.getEstadoSoporte() == false}">
                        <a href="soporte?action=estado&idSoporte=${soporteL.getIdSoporte()}&estado=true"><button class="btn btn-danger"  type="button">Por aprobar</button> </a>
                </c:if>
                </td>
                    <td>
                      <div>
  ...
  <script src="views//vendor/quill/quill.min.js"></script>
