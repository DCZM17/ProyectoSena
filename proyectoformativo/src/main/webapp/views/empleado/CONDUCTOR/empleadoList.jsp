...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="views/menus/menuConductor.jsp">
        ...
        <ul id="empleado-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="empleado?action=listarC">
      ...
      <li class="nav-item">
        ...
        <ul id="horariosR-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="horarioRegistrado?accion=gestionarC">
              <i class="bi bi-circle"></i><span>Gestionar</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        ...
        <ul id="horariosA-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="horarioAsig?action=listarC">
              <i class="bi bi-circle"></i><span>Gestionar</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        ...
        <ul id="soportes-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="soporte?action=registrarC">
              <i class="bi bi-circle"></i><span>Crear</span>
            </a>
          </li>
          <li>
            <a href="soporte?action=listarC">
              <i class="bi bi-circle"></i><span>Gestionar</span>
            </a>
          </li>
        </ul>
                  ...
                  <tbody>
                    <c:forEach var="empleadoL" items="${empleadoList}">  
                      <tr>
                        ...
                        <td>${empleadoL.getIdHorarioAsignado()}</td>
                        <td>
